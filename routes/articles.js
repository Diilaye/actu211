...
router.put('/active/:id', require('../middleweares/auth').checkRole('administrateur'), require('../controllers/article').ActiveArticle);
router.put('/:id', require('../middleweares/auth').checkRole('administrateur'), require('../controllers/article').update);
